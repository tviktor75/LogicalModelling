...
Node.prototype.addAnnotation = function(aForWhat, aText, aAnnX, aAnnY, aAnnW, aAnnH) {
	aAnnW = aAnnW || this.width;
	aAnnH = aAnnH || 20;
  if(!this.annotations) {
...
DiagramFigure.prototype.toJSON=function() {
  ...
  if (typeof(this.annotations) != "undefined") {
    ...
    for (var j=0; j<this.annotations.length; j++) {
      ...
      js_ann['x'] = ann.getX();
      js_ann['y'] = ann.getY();
			js_ann['w'] = ann.getWidth();
			js_ann['h'] = ann.getHeight();
